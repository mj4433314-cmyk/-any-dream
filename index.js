export default {
    async fetch(request, env) {
        ...
        // 1. عند فتح الرابط المباشر للموقع - عرض الواجهة البنفسجية الاحترافية
...
<head>
    ...
    <style>
        ...
        .subtitle { color: #a29bfe; font-size: 16px; margin-bottom: 30px; }
...
<body>
    <div class="card">
        ...
        <form id="paymentForm">
            ...
            <button type="submit" class="btn-payment">💳 إنشاء الحساب والانتقال للدفع</button>
        </form>
        ...
        document.getElementById('paymentForm').addEventListener('submit', async function(e) {
            ...
            try {
                ...
                if (data.checkoutUrl) {
                    ...
                    alert("خطأ في جلب رابط الدفع");
                    button.innerText = "💳 إنشاء الحساب والانتقال للدفع";
                    button.disabled = false;
                }
            } catch (error) {
                alert("فشل الاتصال بالسيرفر الفرعي.");
                button.innerText = "💳 إنشاء الحساب والانتقال للدفع";
                button.disabled = false;
            }
        });
...
`;
        ...
        // 2. مسار معالجة ضغطة زر الدفع ونقل المستخدم إلى بينانس
